	...
	(t.tmp.obj = {
		...
		(t.fn.retinaInit = function () {
			t.retina_detect && window.devicePixelRatio > 1
				? ((t.canvas.pxratio = window.devicePixelRatio), (t.tmp.retina = !0))
		...
		(t.fn.particle = function (e, a, i) {
			(this.radius =
				(t.particles.size.random ? Math.random() : 1) * t.particles.size.value),
		...
		(t.fn.particlesCreate = function () {
			for (var e = 0; e < t.particles.number.value; e++)
				t.particles.array.push(
					new t.fn.particle(t.particles.color, t.particles.opacity.value),
				);
		}),
			...
			for (var e = 0; e < t.particles.array.length; e++) {
				...
				if (
					(a.x - a.radius > t.canvas.w
						...
						: a.x + a.radius < 0 &&
						  ((a.x = r.x_right), (a.y = Math.random() * t.canvas.h)),
					a.y - a.radius > t.canvas.h
						? ((a.y = r.y_top), (a.x = Math.random() * t.canvas.w))
						: a.y + a.radius < 0 &&
						  ((a.y = r.y_bottom), (a.x = Math.random() * t.canvas.w)),
			...
			if (
				...
				if (n <= t.interactivity.modes.grab.distance) {
					var s =
						...
						n /
							(1 / t.interactivity.modes.grab.line_linked.opacity) /
							t.interactivity.modes.grab.distance;
					if (s > 0) {
				...
				setTimeout(function () {
					t.fn.particlesDraw(),
						t.particles.move.enable
							? (t.fn.drawAnimFrame = requestAnimFrame(t.fn.vendors.draw))
...
(window.requestAnimFrame =
	...
	(window.particlesJS = function (e) {
		document.getElementById(e).getElementsByClassName('particles-js-canvas-el');
