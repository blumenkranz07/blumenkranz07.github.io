		...
		(this.WOW = (function () {
			...
			return (
				...
				(r.prototype.doSync = function (t) {
					...
					if (!this.stopped) {
						...
						for (
							s = [],
								n = 0,
								i = (r = (t = t.parentNode || t).querySelectorAll(
									'.' + this.config.boxClass,
								)).length;
							i > n;
							n++
					...
					for (n in ((r = []), e))
						(i = e[n]),
							...
							r.push(
								function () {
									var e, r, s, a;
									for (a = [], e = 0, r = (s = this.vendors).length; r > e; e++)
										(o = s[e]),
											a.push(
				...
				(r.prototype.vendorCSS = function (t, e) {
					var n, i, o, r, s, a;
					for (
						n = (i = window.getComputedStyle(t)).getPropertyCSSValue(e),
							r = 0,
							s = (a = this.vendors).length;
						s > r;
						r++
					)
						(o = a[r]), (n = n || i.getPropertyCSSValue('-' + o + '-' + e));
					return n;
				}),
